...
A Laravel-based Report Module for managing legal-aid providers and reports.

## Overview

This repository contains a Laravel application providing models, migrations, and admin resources for legal aid providers and reports.
...
3. Install JS dependencies and build assets (optional in local dev):
